<?php $__env->startSection('title', 'زیادکردنی خەرجی'); ?>
<?php $__env->startSection('page-title', 'زیادکردنی خەرجی'); ?>
<?php $__env->startSection('page-subtitle', 'تۆمارکردنی خەرجکردنی پارەی نوێ'); ?>

<?php $__env->startSection('content'); ?>
<div class="flex items-center justify-between mb-4">
    <h2 class="text-base font-bold text-slate-800">خەرجی نوێ</h2>
    <a href="<?php echo e(route('expenses.index')); ?>" class="btn-outline">گەڕانەوە</a>
</div>

<div class="card p-5 max-w-3xl">
    <form method="POST" action="<?php echo e(route('expenses.store')); ?>" class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <?php echo csrf_field(); ?>

        <div class="sm:col-span-2">
            <label class="label">وەرگر <span class="text-red-500">*</span></label>
            <input type="text" name="payee" value="<?php echo e(old('payee')); ?>" class="input-field" required>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <input type="date" name="expense_date" value="<?php echo e(old('expense_date', date('Y-m-d'))); ?>" class="input-field" required>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="sm:col-span-2 flex gap-2">
            ...
            <a href="<?php echo e(route('expenses.index')); ?>" class="btn-outline">پاشگەزبوونەوە</a>
        </div>
    </form>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/workspace/accounting-system/resources/views/expenses/create.blade.php ENDPATH**/ ?>