...
<head>
    <meta charset="utf-8">
    <title>وەسڵی کڕین #<?php echo e($invoice->id); ?></title>
    <style>
...
<div class="page">
    <div class="head">
        <div class="brand">
            <?php if($logo): ?><img src="<?php echo e($logo); ?>" alt="logo"><?php endif; ?>
            <div>
        ...
        <div class="doc-meta">
            <div>وەسڵی کڕین: <b>#<?php echo e($invoice->id); ?></b></div>
            <div>بەروار: <b><?php echo e(optional($invoice->date)->format('Y-m-d')); ?></b></div>
            <?php if($invoice->project): ?><div>پڕۆژە: <b><?php echo e($invoice->project->name); ?></b></div><?php endif; ?>
        </div>
    </div>

    <h2 class="section">زانیاری دابینکەر / گەیەنەر</h2>
    <div class="info">
        <div><span>دابینکەر/گەیەنەر: </span><b><?php echo e($invoice->party_name); ?></b></div>
        <?php if($invoice->deliverer_phone): ?><div><span>مۆبایل: </span><b><?php echo e($invoice->deliverer_phone); ?></b></div><?php endif; ?>
        <?php if($invoice->deliverer_address): ?><div><span>ناونیشان: </span><b><?php echo e($invoice->deliverer_address); ?></b></div><?php endif; ?>
        <?php if($invoice->vehicle_number): ?><div><span>ژمارەی ئۆتۆمبێل: </span><b><?php echo e($invoice->vehicle_number); ?></b></div><?php endif; ?>
        <?php if($invoice->vehicle_type): ?><div><span>جۆری ئۆتۆمبێل: </span><b><?php echo e($invoice->vehicle_type); ?></b></div><?php endif; ?>
    </div>
    ...
    <div class="totals">
        <div class="box">
            ...
            <div class="row"><span>کۆی گشتی</span><b><?php echo e($num($invoice->total_iqd)); ?></b></div>
            <div class="row"><span>دراوە</span><b><?php echo e($num($invoice->paid_iqd)); ?></b></div>
            <div class="row rem"><span>ماوە (قەرز)</span><b><?php echo e($num($invoice->remaining_iqd)); ?></b></div>
        </div>
        <div class="box">
            <h3>دۆلاری ئەمریکی ($)</h3>
            <div class="row"><span>کۆی گشتی</span><b><?php echo e($num($invoice->total_usd)); ?></b></div>
            <div class="row"><span>دراوە</span><b><?php echo e($num($invoice->paid_usd)); ?></b></div>
            <div class="row rem"><span>ماوە (قەرز)</span><b><?php echo e($num($invoice->remaining_usd)); ?></b></div>
        </div>
    </div>

    <?php if($invoice->notes): ?>
        <div class="notes"><b>تێبینی: </b><?php echo e($invoice->notes); ?></div>
    <?php endif; ?>
...
<?php /**PATH /home/runner/workspace/accounting-system/resources/views/purchase-invoices/print.blade.php ENDPATH**/ ?>