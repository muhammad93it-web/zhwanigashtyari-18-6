    ...
    <script>
        tailwind.config = {
            theme: { extend: {
                ...
                colors: {
                    gold: { 300: '#f3d68a', 400: '#eec24f', 500: '#e0a82e', 600: '#c08e20' },
                },
            } }
        };
    </script>
    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-[#0d2530]/70 backdrop-blur border border-teal-700/30 rounded-2xl p-6 sm:p-8 shadow-2xl">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-5">
                ...
                <div>
                    <label class="block text-sm font-semibold text-teal-200 mb-1.5">وشەی نهێنی</label>
                    <div class="relative">
                ...
                <div class="flex items-center justify-between">
                    <label class="flex items-center gap-2 text-sm text-teal-300 cursor-pointer">
                        <input type="checkbox" name="remember" class="rounded border-teal-600 bg-transparent">
                        لەبیر بکەوە
                    </label>
                    <a href="{{ route('password.request') }}" class="text-sm text-gold-400 hover:text-gold-300 transition-colors">
