...
@section('title', 'زیادکردنی داهات')
@section('page-title', 'زیادکردنی داهات')
@section('page-subtitle', 'تۆمارکردنی وەرگرتنی پارەی نوێ')
...
<div class="card p-5 max-w-3xl">
    <form method="POST" action="{{ route('incomes.store') }}" class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        @csrf

        <div class="sm:col-span-2">
            <label class="label">سەرچاوە <span class="text-red-500">*</span></label>
            <input type="text" name="source" value="{{ old('source') }}" class="input-field" required>
        ...
        <div>
            ...
            <input type="date" name="income_date" value="{{ old('income_date', date('Y-m-d')) }}" class="input-field" required>
        ...
        <div class="sm:col-span-2 flex gap-2">
            ...
            <a href="{{ route('incomes.index') }}" class="btn-outline">پاشگەزبوونەوە</a>
        </div>
    </form>
</div>
@endsection
