...
<body>
    <table>
        <tr><td class="title" colspan="6">ژوانی گەشتیاری — کەشف حساب</td></tr>
        <tr><td colspan="6">کەس: {{ $supplier->name }}@if($supplier->phone) — مۆبایل: {{ $supplier->phone }}@endif</td></tr>
    ...
    <table>
        ...
        @foreach($transactions as $t)
            <tr>
                ...
                <td>{{ ($t->type == 'purchase' ? '+' : '-') . $num($t->amount) }}</td>
