...
<div class="card p-5 max-w-3xl">
    <form method="POST" action="{{ route('expenses.update', $expense) }}" class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
            ...
            <input type="text" name="expense_type" value="{{ old('expense_type', $expense->expense_type) }}" class="input-field" placeholder="نموونە: کرێی کرێکار، گواستنەوە">
        ...
        <div class="sm:col-span-2">
            ...
            <textarea name="reason_description" rows="2" class="input-field" placeholder="بۆچی ئەم پارەیە خەرجکرا؟">{{ old('reason_description', $expense->reason_description) }}</textarea>
